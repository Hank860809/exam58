...
Route::patch('/admin/exam/{exam}', 'ExamController@update')->name('exam.update');
...
Route::delete('/admin/exam/{exam}', 'ExamController@destroy')->name('exam.destroy');
Route::post('/test', 'TestController@store')->name('test.store');
Route::get('/test/{test}', 'TestController@show')->name('test.show');
Route::get('/admin/create', 'ExamController@create')->name('exam.create');
Route::get('/admin/exam', 'ExamController@index');
Route::get('admin/exam/{exam}', 'ExamController@show');
